...
const myFirstArray = ["Аня", 21, true]
...
const twoCountries = countries.shift();
...
const cities = ['Санкт-Петербург', 'Москва', 'Екатеринбург', ...russianCities];
console.log(cities);
...
const sumNumbers = numbers[0] + numbers[9];
